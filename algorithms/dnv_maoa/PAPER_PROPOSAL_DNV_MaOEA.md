...
Propomos o **Dynamic Normal Vectors for Many-Objective Optimization (DNV-MaOEA)**, uma nova arquitetura híbrida de Duas Camadas (Two-Layer Architecture) que combina métodos estocásticos com adaptação topológica:
...
- **1. Introduction:** Evolução dos MaOEAs, o problema dos vetores estáticos, as tentativas recentes de vetores dinâmicos e suas falhas no início da busca, e a proposta do DNV-MaOEA.
- **2. Related Work:**
...
- **4. Experimental Setup:**
    ...
    - Baselines: NSGA-III, RVEA, e o SSW original.
    - Métricas: Averaged Hausdorff Distance ($\Delta_p$).
- **5. Results and Discussion:**
    - Validação da não-regressão em frentes regulares (DTLZ2).
    - Superioridade estatística e estabilidade topológica em frentes desconectas (DTLZ7).
