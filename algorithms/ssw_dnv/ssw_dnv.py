...
"""
SSW-DNV — Schaeffler-SDE-Weighted · Dynamic Normal Vectors, 2026
=====================================================================
...
class SSW_DNV(Algorithm):
    """
    SSW-DNV: Schaeffler-SDE-Weighted · Dynamic Normal Vectors.
    ...
    def _update_eej(self, pop: Population) -> None:
        ...
        try:
            ...
            import warnings
            warnings.warn(
                "SSW_DNV: NDS fallback triggered in _advance() — using full population for EEJ.",
                RuntimeWarning,
                stacklevel=2,
            )
            X_nd = X
